...
export default function MakeRequest(){ 
 ...
 "url('./sea.jpg')", 
    ...
    const [devisionID, setDivisionID] = useState(""); //data or properties that need to be tracking in an application.
    ...
    function sendData(){
        ...
        axios.post('http://localhost:8000/add',newRequest).then(()=>{
    ...
    return(
      ...
      <div className="col-md-7 col-md-push-5" style={{marginLeft:'1000px', marginTop:'300px'}}>
          <div className="booking-cta">
              <h1 style={{color:'lightGray', fontWeight:'bold'}}>Want To View Your <br></br>
                  All Requests </h1>
              <Link to="/">
                        <button type="button" className="btn btn-md btn-warning" style={{textDecoration:'none',  marginRight:'600px' , width:'150px', marginTop:'30px'}}><i className="fa fa-wpforms"></i>  View Requests </button>
                    </Link>
          </div>
      </div>
               ...
               <div className="container" style={{marginLeft:'10px',marginRight:'20px', marginBottom:'60px', marginTop:'-1px'}}>
                <p style={{textAlign: "center",padding:"40px 20px 15px 0px",color:"MidnightBlue",fontFamily: "Fantasy",fontSize: "30px"}}>REQUEST &nbsp; FORM</p>
