...
<div style={{width:'80%'}}>
          ...
          <a href={`/update/${id}`}>
                  ...
                  <Link to="/">
                        <button type="button" className="w-20 btn-lg btn-primary" style={{textDecoration:'none', float: "right", margin:"5px 300px 10px 20px" }}><i className="fa fa-wpforms"></i>  View Requests </button>
                    </Link>
